...
print(lc_calc.binary_star_lc(star1_params, star2_params, binary_params,
          observation_times, use_blackbody_atm=True, make_mesh_plots=True,
          plot_name=plot_name+'_500', print_diagnostics=True,
          num_triangles=500))
