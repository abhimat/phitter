...
params_table = Table.read('./stellar_params.h5', path='data')
num_samples = len(params_table)

## Read in stellar parameters
K_ext_samps = params_table['K_ext'][rows_ignore:]
H_ext_mod_samps = params_table['H_ext_mod'][rows_ignore:]
...
star1_logg_samps = params_table['star1_logg'][rows_ignore:]
...
star2_logg_samps = params_table['star2_logg'][rows_ignore:]
...
param_samps_plotter(star1_logg_samps, 'star1_logg', r"$\\log g$", '', plot_kde=False)
...
param_samps_plotter(star2_logg_samps, 'star2_logg', r"$\\log g$", '', plot_kde=False)
...
param_samps_plotter(H_ext_mod_samps, 'H_ext_mod', r"$A_{H}$ Mod", '', plot_kde=False)
