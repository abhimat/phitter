...
class isochrone_mist(object):
    filt_list = ['nirc2,Lp', 'nirc2,Kp', 'nirc2,H']
    ...
    def rad_interp(self, star_rad_interp):
        ...
        if self.iso_rad[-1] < self.iso_rad[0]:
            ...
            self.iso_mag_Lp = self.iso_mag_Lp[::-1]
        ...
        star_mag_Lp = np.interp(star_rad_interp, self.iso_rad, self.iso_mag_Lp)
        ...
        star_absMag_Lp = np.interp(star_rad_interp, self.iso_absMag_rad, self.iso_absMag_Lp)
        ...
        star_pblum_Lp, star_pblum_Kp, star_pblum_H =\
            self.calc_pb_lums(star_absMag_Lp, star_absMag_Kp, star_absMag_H)
        ...
        stellar_params_all = (star_mass_init, star_mass, star_rad, star_lum, star_teff, star_logg,
                              star_mag_Lp, star_mag_Kp, star_mag_H,
                              star_pblum_Lp, star_pblum_Kp, star_pblum_H)
    ...
    def mass_init_interp(self, star_mass_init_interp):
        ...
        star_mag_Lp = np.interp(star_mass_init_interp, self.iso_mass_init, self.iso_mag_Lp)
        ...
        star_absMag_Lp = np.interp(star_mass_init_interp, self.iso_absMag_mass_init, self.iso_absMag_Lp)
    ...
    def mass_interp(self, star_mass_interp):
        ...
        star_mag_Lp = np.interp(star_mass_interp, self.iso_mass, self.iso_mag_Lp)
        ...
        star_absMag_Lp = np.interp(star_mass_interp, self.iso_absMag_mass, self.iso_absMag_Lp)
